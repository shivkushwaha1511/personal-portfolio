...
export const LeetCode = (props) => {
  return (
    ...
    >
      ...
      <path
        fill={props.fill}
        d="m21.5 23.9-3.6 3.5c-.6.6-1.5.9-2.4.9s-1.9-.3-2.5-.9l-5.8-5.8c-.6-.6-.9-1.5-.9-2.5s.3-1.8.9-2.4l5.8-5.8c.6-.6 1.5-.9 2.4-.9.9 0 1.8.3 2.4.9l3.6 3.5c.7.7 1.8.7 2.5-.1.7-.7.7-1.8 0-2.5l-3.5-3.5c-.9-.9-2-1.5-3.3-1.8l3.3-3.3c.7-.7.7-1.8 0-2.5S18.7-.2 18 .5L4.6 14c-1.3 1.3-2 3.1-2 5.1 0 2 .7 3.9 2 5.2l5.8 5.8c1.3 1.3 3.1 1.9 5.1 1.9 2 0 3.8-.7 5.1-2l3.5-3.5c.7-.7.7-1.8-.1-2.5s-1.8-.8-2.5-.1zm6.2-6.6H14.2c-.9 0-1.7.8-1.7 1.8s.8 1.8 1.7 1.8h13.5c.9 0 1.7-.8 1.7-1.8 0-.9-.7-1.8-1.7-1.8z"
      />
    </svg>
  );
};
...
export const Web = (props) => {
  return (
    ...
    >
      <path
        fill={props.fill}
        d="M369.182 0H52.513v512h406.974V90.305L369.182 0zm-1.592 54.105 37.792 37.792H367.59V54.105zm52.513 418.51H91.897V39.385h236.308v91.897h91.897v341.333z"
      />
      <path
        fill={props.fill}
        d="m327.688 218.445-27.848 27.848 33.337 33.338-33.337 33.338 27.848 27.847 61.187-61.185zM212.16 246.293l-27.848-27.848-61.187 61.186 61.187 61.185 27.848-27.847-33.337-33.338zM254.67 190.359l-37.587 178.544h40.247l37.589-178.544z"
      />
    </svg>
  );
};
